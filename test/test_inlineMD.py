...
from inlineMD import split_nodes_delimiter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_link, text_to_textnode
...
class Testextract_markdown_images(unittest.TestCase):
    ...
    def test_extract_markdown_images(self):
        text = "This is text with a ![image](url) word [link](url)"
    ...
    def test_split_nodes_image(self):
        ...
        text = TextNode("This is text with a ![image](url) and[link](url)", text_type_text,)
        ...
        self.assertEqual(split_nodes_image([text]),[TextNode("This is text with a ", text_type_text),TextNode("image", text_type_image, "url"),TextNode(" and[link](url)", text_type_text)])
